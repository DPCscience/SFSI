...
All the available observation contribute to the predicted breeding value (*u*<sub>*i*</sub>) (<img src="https://render.githubusercontent.com/render/math?math=u_i">) of the *i*<sup>th</sup> candidate of selection as a linear combination of the form:
